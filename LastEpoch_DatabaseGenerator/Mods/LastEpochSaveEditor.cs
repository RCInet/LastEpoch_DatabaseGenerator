...
namespace LastEpoch_DatabaseGenerator.Mods
{
    public class LastEpochSaveEditor
    {
        ...
        public static void GetAllCharactersSkills(Main main)
        {
            ...
            foreach (CharacterClass c_class in characters_class)
            {
                ...
                {
                    System.Collections.Generic.List<Skill_Node_Structure> nodes = new System.Collections.Generic.List<Skill_Node_Structure>();
                    /*foreach (Mods.Skills_Mods.node_structure node_str in Functions.GetAllNode(ability.abilityName, main))
                    {
                        nodes.Add(new Skill_Node_Structure
                        {
                            Name = node_str.name,
                            Id = node_str.id,
                        });
                    }*/
                    Default_Skills.Add(AbilityToSkill(ability, nodes));
                ...
                {
                    System.Collections.Generic.List<Skill_Node_Structure> nodes = new System.Collections.Generic.List<Skill_Node_Structure>();
                    /*foreach (Mods.Skills_Mods.node_structure node_str in Functions.GetAllNode(ability_level.ability.abilityName, main))
                    {
                        nodes.Add(new Skill_Node_Structure
                        {
                            Name = node_str.name,
                    ...
                    Default_Skills.Add(AbilityToSkill(ability_level.ability, nodes));
                ...
                foreach (Mastery masterie in c_class.masteries)
                {
                    ...
                    foreach (AbilityAndLevel ability_level in masterie.abilities)
                    {
                        ...
                        MasterySkills.Add(AbilityToSkill(ability_level.ability, nodes));
        ...
        public struct Skill_structure
        {
            public string Name;
            public string Id;
            public System.Collections.Generic.List<Skill_Node_Structure> Nodes;
        ...
        public static Skill_structure AbilityToSkill(Ability ability, System.Collections.Generic.List<Skill_Node_Structure> nodes)
        {
        ...
        public struct Skill_Node_Structure
        {
            public string Name;
            public int Id;
        }
